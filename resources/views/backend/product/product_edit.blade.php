...
<div class="row"> <!-- start 4th row  -->
	    ...
	    <div class="form-group">
			...
			<div class="controls">
	 <input type="text" name="product_tags" value="{{ $products->product_tags }}" class="form-control" data-role="tagsinput" >
     @error('product_tags') 
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 		 </div>
			...
			<div class="controls">
					 <input type="text" name="product_size" value="{{ $products->product_size }}" class="form-control" data-role="tagsinput" required="">
				     @error('product_size') 
					 <span class="text-danger">{{ $message }}</span>
					 @enderror
	 		 </div>
			...
			<div class="row"> <!-- start 7th row  -->
				<div class="col-md-6">
				    ...
				    <div class="form-group">
						...
						<div class="controls">
					<textarea name="short_descp" id="textarea" class="form-control"  placeholder="Textarea text">
